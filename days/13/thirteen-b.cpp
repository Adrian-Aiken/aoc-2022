...
int main()
{
    ...
    packets.push_back(PacketList(DIV1));
    packets.push_back(PacketList(DIV2));
    ...
    {
        if (packets[i].orig == DIV1) div1i = i+1;
        if (packets[i].orig == DIV2) div2i = i+1;
    }
    
    cout << "Output: " << div1i * div2i << endl;
}